...
/**
 * Payamito Gateway Implementation
 * 
 * Provides integration with Payamito REST API.
 * 
 * @author Sayyed Jamal Ghasemi
 * @see https://rest.payamak-panel.com
 */
class Payamito extends AbstractGateway
{
    ...
    {
        // Payamito doesn't support bulk different messages
    ...
    public function getSMSStatus($messageId): string
    {
        ...
        if ($response['status'] && isset($response['resultData'])) {
            // Payamito returns delivery status codes
    ...
    public function getCredit(): int
    {
        ...
        // Payamito returns credit in Value field when successful
    ...
    protected function parseResponse(string $response): array
    {
        ...
        // Payamito uses RetStatus field: 1 = success, other = error
